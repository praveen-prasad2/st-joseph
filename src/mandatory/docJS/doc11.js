...
function DocOne() {
    ...
    const docs = [
        { uri: require("../../assets/files/Primary/11 LAST THREE-YEAR RESULT OF THE BOARD EXAMINATION.pdf"),  
        fileName: '11. LAST THREE-YEAR RESULT OF THE BOARD EXAMINATION AS PER APPLICABILITY', } // Local File
      ];
